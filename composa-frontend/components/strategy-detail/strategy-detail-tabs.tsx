      ...
      <div className="flex gap-1 border-b border-border">
        {TABS.map((tab) => (
          ...
          >
            ...
            {activeTab === tab && (
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-primary to-accent" />
            )}
          </button>
        ))}
      </div>
      ...
      <div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {strategy.description ??
                  "No on-chain metadata available for this strategy yet."}
              </p>
            </div>
        ...
        {activeTab === "performance" && (
          <div className="space-y-6">
            <div>
              ...
              {strategy.performanceData.length === 0 ? (
                <div className="glassmorphism border border-border rounded-xl p-6 text-center text-muted-foreground">
        ...
        {activeTab === "composition" && (
          <div className="space-y-4">
            ...
            {strategy.composition.length === 0 ? (
              <div className="glassmorphism border border-border rounded-xl p-6 text-center text-muted-foreground">
                No on-chain composition data available.
              </div>
            ) : (
              strategy.composition.map((step, index) => (
                <div
                  key={index}
                  className="glassmorphism border border-border p-4 rounded-xl"
                >
        ...
        {activeTab === "forks" && (
          <div className="space-y-4">
            <h2 className="text-xl font-bold mb-4">
              Forks ({strategy.forks ?? 0})
            </h2>
            <div className="glassmorphism border border-border rounded-xl p-6 text-center text-muted-foreground">
              On-chain fork activity will appear here once strategies are
        ...
        {activeTab === "activity" && (
          <div className="space-y-4">
            ...
            {strategy.recentActivity.length === 0 ? (
              <div className="glassmorphism border border-border rounded-xl p-6 text-center text-muted-foreground">
